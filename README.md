...
for all images. Files land in `outputs/YYYY-MM-DD-HH-MM-SS/`. Three cards are
...
```bash
./scry "…" --count 3 --width 512 --height 1024 --steps 25 \
  --negative "text letters label title panels comics captions subtitle"
```
